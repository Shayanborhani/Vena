      ...
      <div className="screen-scroll pad-top" style={{ paddingBottom: 120 }}>
        <div style={{ padding: "12px 22px 0" }}>
          ...
          <p style={{ color: "var(--ink-2)", fontSize: 15.5, lineHeight: 1.5, margin: "0 0 20px" }}>
            Four partners, picked for what your panel actually showed—in the order I’d tackle them.
          </p>
        </div>
...
function PlanScreen({ go }) {
  const { PATIENT } = window.VENA;
  const [tasks, setTasks] = React.useState([
    { t: "Start vitamin D3 + K2", d: "Daily, with food", done: false },
    { t: "Add iron-rich meals", d: "Sofia’s plan — 3 this week", done: false },
    { t: "Two zone-2 walks", d: "30 min each", done: true },
  ]);
      ...
      <div className="screen-scroll pad-top" style={{ paddingBottom: 120 }}>
        ...
        <div style={{ padding: "0 22px" }}>
          ...
          <div className="card" style={{ padding: 18, display: "flex", gap: 14, alignItems: "center",
            ...
            <div style={{ width: 50, height: 50, borderRadius: 15, flexShrink: 0, display: "grid", placeItems: "center",
              background: "var(--alert-tint)", color: "var(--alert)" }}><Icon name="video" size={25} /></div>
            <div style={{ flex: 1 }}>
              <div style={{ fontWeight: 600, fontSize: 16.5 }}>Dr. Lena Hoffmann</div>
              <div className="num" style={{ fontSize: 13.5, color: "var(--ink-2)" }}>Video consult · Today, 4:30 PM</div>
            </div>
            <button style={{ border: "none", background: "var(--alert)", color: "#fff", fontWeight: 600,
        ...
        <div style={{ padding: "20px 22px 0" }}>
          <div className="card" style={{ padding: 18, display: "flex", gap: 14, alignItems: "center",
            ...
            <div style={{ flex: 1 }}>
              ...
              <div style={{ fontSize: 13, color: "var(--ink-2)" }}>We’ll mail a kit so you can see if CRP is falling.</div>
            </div>
