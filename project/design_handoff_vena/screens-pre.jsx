  ...
  return (
    <div className="screen" style={{ background:
      ...
      <div className="pad-bot" style={{ padding: "10px 24px 40px", display: "flex", flexDirection: "column", gap: 12 }}>
        <button className="btn btn-teal btn-block rise" style={{ animationDelay: ".3s" }} onClick={() => go("activate")}>
...
function ActivateScreen({ go }) {
  ...
  return (
    <div className="screen">
      ...
      <TopBar onBack={() => go("welcome")} kicker="Step 1 of 3" />
...
Object.assign(window, { WelcomeScreen, ActivateScreen, SampleScreen, ProcessingScreen });
